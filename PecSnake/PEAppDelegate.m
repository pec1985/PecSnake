...
{
	[[NSNotificationCenter defaultCenter] postNotificationName:PAUSE_EVENT object:application];
...
{
	[[NSNotificationCenter defaultCenter] postNotificationName:PAUSED_EVENT object:application];
